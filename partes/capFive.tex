...
\begin{tabular}{@{}p{1.3cm}p{4.5cm}p{4.5cm}p{1.5cm}p{1.8cm}@{}}
\toprule
\textbf{Código} & \textbf{Historia de usuario} & \textbf{Criterios de aceptación} & \textbf{Prioridad} & \textbf{Estimación} \\
\midrule
HU01 & Como administrador, quiero iniciar sesión con usuario y contraseña para acceder de forma segura al sistema. & 
El sistema valida las credenciales del usuario. Se genera un token JWT al iniciar sesión correctamente. Se rechaza el acceso cuando las credenciales son incorrectas. & 
Alta & 3 pts \\
\midrule
HU02 & Como administrador, quiero asignar roles y permisos a los usuarios del sistema para controlar el acceso a los diferentes módulos. & 
Existen al menos dos roles: Administrador y Vendedor. Cada rol posee permisos específicos según el módulo. & 
Alta & 5 pts \\
\midrule
HU03 & Como usuario del sistema, quiero que mi sesión expire automáticamente después de un período de inactividad para evitar accesos no autorizados. & 
El token expira automáticamente. El sistema solicita nuevamente la autenticación. & 
Media & 2 pts \\
\midrule
HU04 & Como administrador, quiero registrar los datos de un cliente para asociarlos a sus proformas. & 
El formulario valida los campos obligatorios. La información se almacena correctamente en la base de datos. & 
Alta & 3 pts \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Planificación de los Sprints (Sprint Planning)}
\label{tab:sprint_planning}
\begin{tabular}{@{}p{2cm}p{7.5cm}p{2cm}@{}}
\toprule
\textbf{Sprint} & \textbf{Historias de usuario / Actividades} & \textbf{Estimación} \\
\midrule
Sprint 1. Seguridad y configuración inicial & 
HU01. Inicio de sesión \newline
HU02. Gestión de roles y permisos \newline
HU03. Expiración automática de la sesión \newline
HU19. Registro de acciones del sistema (logs) \newline
HU20. Baja lógica de registros & 
16 pts \\
\midrule
Sprint 2. Gestión de clientes, productos e inventario & 
HU04. Registro de clientes \newline
HU05. Consulta del historial de proformas \newline
HU06. Edición y baja lógica de clientes \newline
HU07. Registro de productos & 
21 pts \\
\midrule
Sprint 3. Gestión de proformas & 
HU10. Creación de proformas \newline
HU11. Cálculo automático de subtotal, IVA y total \newline
HU12. Generación de proformas en formato PDF \newline
HU13. Envío automático de proformas mediante WhatsApp o correo electrónico & 
26 pts \\
\midrule
Sprint 4. Liquidaciones y panel principal & 
HU14. Registro de liquidaciones \newline
HU16. Panel principal con indicadores \newline
HU17. Navegación mediante menú lateral & 
16 pts \\
\midrule
Sprint 5. Reportes y pruebas finales & 
HU18. Generación de reportes \newline
Ejecución de pruebas funcionales \newline
Corrección de errores detectados \newline
Ajustes finales de la interfaz y optimización del rendimiento & 
5 pts \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Resultados de las Revisiones de Sprint (Sprint Review)}
\label{tab:sprint_review}
\begin{tabular}{@{}p{1.5cm}p{5cm}p{6.5cm}@{}}
\toprule
\textbf{Sprint} & \textbf{Funcionalidades presentadas} & \textbf{Resultado de la revisión} \\
\midrule
Sprint 1 & Módulo de autenticación y seguridad: inicio de sesión, administración de roles y permisos, expiración automática de sesiones, registro de acciones de usuarios. & 
El administrador validó el correcto funcionamiento de los mecanismos de seguridad y aprobó el incremento, sugiriendo ajustes menores en la interfaz de inicio de sesión. \\
\midrule
Sprint 2 & Módulos de gestión de clientes, productos e inventario: registro, consulta, actualización, baja lógica, control de stock y alertas por inventario mínimo. & 
Funcionalidades aceptadas por el Product Owner; se recomendó optimizar la visualización de algunos formularios. \\
\midrule
Sprint 3 & Módulo de proformas: creación de cotizaciones, cálculo automático de subtotal, IVA y total, generación de PDF y envío automático por correo o WhatsApp. & 
El administrador verificó que los cálculos coincidían con los procedimientos de la empresa y aprobó el módulo. \\
\midrule
Sprint 4 & Módulo de liquidaciones, control del estado de pagos y panel principal (Dashboard) con indicadores de clientes, proformas, inventario y ventas. & 
Incremento aceptado al proporcionar información útil para el seguimiento de operaciones y la toma de decisiones. \\
\midrule
Sprint 5 & Reportes administrativos, mejoras incorporadas durante el desarrollo y resultados de las pruebas funcionales e integración. & 
El Product Owner aprobó la versión final del sistema, confirmando que reduce tiempos de elaboración de proformas, disminuye errores y mejora la gestión de información. \\
\bottomrule
\end{tabular}
\end{table}
